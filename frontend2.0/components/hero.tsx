...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative min-h-screen pt-28 pb-16 overflow-hidden bg-neutral-900 text-white flex items-center justify-center">
      ...
      <div className="absolute inset-0 opacity-20 z-10">
        <motion.div
          className="absolute w-72 h-72 rounded-full bg-blue-500 blur-3xl -top-32 -left-20"
          animate={{
        scale: [1, 1.2, 1],
        opacity: [0.5, 0.8, 0.5],
          }}
        ...
        />
        <motion.div
          className="absolute w-[30rem] h-[30rem] rounded-full bg-cyan-400 blur-3xl -bottom-20 -right-20"
          animate={{
        scale: [1, 1.1, 1],
        opacity: [0.5, 0.7, 0.5],
          }}
        ...
        />
        <motion.div
          className="absolute w-80 h-80 rounded-full bg-purple-500 blur-3xl top-1/4 -right-10"
          animate={{
        scale: [1, 1.15, 1],
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-30">
        ...
        <motion.div className="flex flex-col sm:flex-row gap-4 justify-center" variants={itemVariants}>
          <Link
            href="/FinWise"
            className="px-8 py-4 bg-gradient-to-r from-blue-500 to-cyan-400 rounded-full text-white font-bold text-center transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-blue-500/25 focus:outline-none focus:ring-2 focus:ring-cyan-300 focus:ring-offset-2 focus:ring-offset-neutral-900"
          >
            Get Started
          </Link>
          <Link
            href="#howitworks"
            className="px-8 py-4 bg-neutral-800 border border-neutral-700 backdrop-blur-lg rounded-full text-white font-bold text-center transition-all duration-300 hover:bg-neutral-700 focus:outline-none focus:ring-2 focus:ring-neutral-600 focus:ring-offset-2 focus:ring-offset-neutral-900"
          >
            How It Works
          </Link>
        </motion.div>
          ...
          <div className="w-full max-w-2xl mx-auto">
            <motion.div className="relative w-full max-w-lg mx-auto" variants={itemVariants}>
              ...
              <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl">
                ...
                {/* Glass Card Overlay */}
                <div className="absolute inset-0 bg-gradient-to-b from-transparent to-neutral-900 opacity-60" />

                {/* Glass Card Stats */}
                <div className="absolute bottom-0 left-0 right-0 p-6 backdrop-blur-sm bg-neutral-900/30 border-t border-white/10">
                  <div className="flex justify-between items-center">
                    <div>
                      <p className="text-xs text-cyan-300 uppercase tracking-wider mb-1">Account Balance</p>
