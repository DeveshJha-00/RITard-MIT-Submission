    ...
    return (
      <input
        ...
        className={cn(
          ...
          "dark:border-slate-600 dark:bg-slate-800/90 dark:text-white dark:placeholder:text-slate-400",
          "text-[color:var(--input-color)] placeholder:text-[color:var(--input-placeholder-color)]",
          className
        )}
        ref={ref}
        {...props}
